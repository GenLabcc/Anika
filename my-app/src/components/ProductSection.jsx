...
const PRODUCTS = [
  { id: 1, img: Product1, price: '₹7,840', original: '₹9,800', name: 'Glamore Necklace Set' },
  { id: 2, img: Product2, price: '₹7,840', original: '₹9,800', name: 'Glamore Necklace Set' },
  { id: 3, img: Product3, price: '₹7,840', original: '₹9,800', name: 'Glamore Necklace Set' },
  { id: 4, img: Product4, price: '₹7,840', original: '₹9,800', name: 'Glamore Necklace Set' },
  { id: 5, img: Product5, price: '₹7,840', original: '₹9,800', name: 'Glamore Necklace Set' },
];
  ...
  return (
    <section className="product-section">
      ...
      <div className="product-left">
        <img src={RingHandImg} alt="Ring on hand" className="ring-hand-img" />
      </div>
